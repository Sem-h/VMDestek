...
// ============ SYSTEM WATERMARK ============
(function () { const _0x = ['R2VsaXN0aXJpY2k6', 'U2VtaWggQUtCQcWe', 'U2VuaW9yIFNvZnR3YXJlIERldmVsb3Blcg==', 'aHR0cHM6Ly9zZW1paGFrYmFzLmNvbS50cg==']; const _d = s => decodeURIComponent(escape(atob(s))); const _e = document.createElement('div'); _e.style.cssText = 'position:fixed;bottom:0;left:0;right:0;text-align:center;padding:6px 0;font-size:11px;color:rgba(255,255,255,0.35);z-index:1;pointer-events:auto;background:transparent;font-family:Inter,-apple-system,sans-serif'; const _a = document.createElement('a'); _a.href = _d(_0x[3]); _a.target = '_blank'; _a.style.cssText = 'color:rgba(255,255,255,0.35);text-decoration:none;transition:color 0.2s'; _a.onmouseenter = function () { this.style.color = 'rgba(255,255,255,0.6)' }; _a.onmouseleave = function () { this.style.color = 'rgba(255,255,255,0.35)' }; _a.textContent = `${_d(_0x[0])} ${_d(_0x[1])} - ${_d(_0x[2])}`; _e.appendChild(_a); document.addEventListener('DOMContentLoaded', () => { const t = document.querySelector('.app-container') || document.body; t.appendChild(_e) }); const _p = new MutationObserver(() => { if (!document.body.contains(_e)) { const t = document.querySelector('.app-container') || document.body; t.appendChild(_e) } }); document.addEventListener('DOMContentLoaded', () => { _p.observe(document.body, { childList: true, subtree: true }) }); })();
